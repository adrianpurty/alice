...
def _register_model_safe(config_class, model_class):
    try:
...
_register_model_safe(VibeVoiceAcousticTokenizerConfig, VibeVoiceAcousticTokenizerModel)
_register_model_safe(VibeVoiceSemanticTokenizerConfig, VibeVoiceSemanticTokenizerModel)
